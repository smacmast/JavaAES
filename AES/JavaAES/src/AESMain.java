...
public class AESMain {
	...
	public static void main(String[] args) {
		boolean testing = false; //Only used during development, testing toggled false in final product
	...
	private static void manualMode(){
		...
		do{
			System.out.print("Please Select Action(1: Encrypt Text, 2: Quit): ");
			mode = input.nextInt();
			...
			switch(mode){
				case 1:
					...
					in = input.nextLine();
					key = aes.genNextKey();
					System.out.println("Randomly Generated Key to be used:\t"+key);

					in = aes.Encrypt(in, key);
					System.out.println("\nEncrypted Text :\t" + in + "\n");
					in = aes.Decrypt(in, key);
					System.out.println("\nDecrypted Text :\t" + in + "\n");
					break;
				case 2:
