...
public class AESAlgo {
	...
	public String genNextKey(){
		int bits = this.Nk * 8 * 4;
		String s = new BigInteger(bits, this.random).toString(32);
	...
	private String delPad(String str){
		...
		if (this.pad){str = str.substring(0, len-padVal);this.pad =false;} //returns string without padding text
